...
const events = [
    ...
    {
         title: ["Esports Showcase Week Launch","Lancement de la semaine du sport électronique"],
         image: ["../../images/events/upcoming/lol.png","League of Legends logo","Logo de League of Legends"],
         text: ["Join us for the launch of a week of Esports presentations and activities. The launch event will include an exhibition match of League of Legends, featuring Esports Caster, Rare Adam (Adam Choles), Director of Digital Media, NECC.<br><i>(Bilingual launch, game commentary in English)</i><br>Students may choose to sign up to this event <a href='https://forms.gle/Jumt1SCNEpHsXWSK6' rel='external' target='_blank'>in person</a> or <a href='https://uottawa-ca.zoom.us/meeting/register/tJwscu6orj4oG9RUyjIN3LfI5PJP5OOy0pKA#/registration' rel='external' target='_blank'>be there online</a> if they're interested.","Joignez-vous à nous pour le lancement d’une semaine de présentations et d’activités liées au sport électronique. L’événement de lancement comprendra un match d’exhibition de League of Legends commenté en direct par Rare Adam (Adam Choles), Directeur des médias numériques, NECC.<br><i>(Lancement bilingue, commentaire du match en anglais)</i><br>Les étudiants peuvent choisir de s'inscrire à cet évènement <a href='https://forms.gle/Jumt1SCNEpHsXWSK6' rel='external' target='_blank'>en personne</a>, ou d'être là <a href='https://uottawa-ca.zoom.us/meeting/register/tJwscu6orj4oG9RUyjIN3LfI5PJP5OOy0pKA#/registration' rel='external' target='_blank'>en ligne</a> si intéressés."],
         date: ["Monday, March 11, 2024","lundi, 11 mars, 2024"],
         time: ["11:30AM - 1:00PM","11h30 - 13h00"],
         location: ["Brian Dickson Law Library - FTX430 || Online","Bibliothèque de droit Brian Dickson || En Ligne"],
         contact: ["uOttawa Esports Copresidents","Coprésidentes d'Esports uOttawa"],
    },
    // {
