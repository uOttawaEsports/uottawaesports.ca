...
const events = [
     ...
     {
         title: ["VCT Watchparty","Visionnement en personne de VCT"],
         image: ["../../images/events/upcoming/val.png","Valorant logo","logo de Valorant"],
         text: ["VCT kicks off in Madrid! We will be streaming one of the Valorant Champions Tour (VCT) matches featuring Gen. G vs Loud! Register through <a href='https://forms.gle/q8MqKJrggvxotwU9A' rel='external' target='_blank'>this form</a> to not only attend in person as we have <b>limited spots</b>, but we'll also be raffling away <b>a 25$ Amazon gift card</b> amongst students who sign up as well!","VCT démarre à Madrid! Nous visionnerons en direct un des deux matchs du Valorant Champions Tour (VCT) avec Gen.G vs Loud ! Les places sont <b>limitées</b>, alors inscrivez-vous <a href='https://forms.gle/q8MqKJrggvxotwU9A' rel='external' target='_blank'>à travers ce formulaire</a> puisqu'on tirera <b>une carte cadeau d'Amazon de 25 $</b> au sort parmi les étudiants inscrits !"],
         date: ["Thursday, March 14, 2024","jeudi, 14 mars, 2024"],
         time: ["2:00PM","14h00"],
         location: ["Brian Dickson Law Library - FTX430 || Online","Bibliothèque de droit Brian Dickson - FTX430 || En ligne"],
         contact: ["uOttawa Esports Copresidents","Co-Présidentes d'uOttawa Esports"],
