function more(name) {
    ...
    let modals = {
        ...
        "jaxon murphy": {
            ...
            background: "background-image: linear-gradient(#000000a4, #000000a4), url(../../../images/execs/2021-2022/backgrounds/jaxon-murphy.webp); background-repeat: no-repeat; background-size: cover; background-position-x: 50%; background-position-y: 50%; background-position-x: 50%;"
        },
        "dhruv kumar": {
            title: "Dhruv Kumar",
            ...
            game: "",
            desc: "Hello!",
            background: "background-image: linear-gradient(#000000a4, #000000a4), url(../../../images/execs/uottawa-aerial.jpg); background-repeat: no-repeat; background-size: cover; background-position-x: 50%; background-position-y: 50%;"
        },
        /* Execs */
        "alex lisitsas": {
            title: "Alex Lisitsas",
        ...
        "steven li": {
            ...
            background: "background-image: linear-gradient(#000000a4, #000000a4), url(../../../images/execs/2021-2022/backgrounds/steven-li.gif); background-repeat: no-repeat; background-size: cover; background-position-x: 50%; background-position-y: 50%;"
        },
        "prem gupta": {
            title: "Prem Gupta",
            image: "../../../images/execs/placeholder.png",
